...
public class MainViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Cliente cliente1 = new Cliente(1, "pepe Pere", "pepe@pere.com");
        Cliente cliente2 = new Cliente(2, "Señor Gato", "señor@gato.com");
        Cliente cliente3 = new Cliente(3, "Ole maria", "ole@maria.com");
        Cliente cliente4 = new Cliente(4, "Pakito Sierra", "pakito@sierra.com");
        Cliente cliente5 = new Cliente(5, "Jose asnar", "jose@asnar.com");
    ...
    private boolean comprobarCampos() {
        ...
        if (txtMatricula.getText() == null || Objects.equals(txtMatricula.getText(), "")) {
            out = false;
            mostrarAlerta("Miguel Navas", "Campo Vacio");

        }

        if (datePickSalida.getValue() == null || datepickEntrada.getValue() == null) {
            out = false;
            mostrarAlerta("Miguel Navas", "Uno de las fechas esta vacia");
